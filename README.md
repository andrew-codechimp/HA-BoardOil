...
Card viewing is not available from the UI because cards support complex features like fields, tags, and column transitions that Home Assistant Todo lists do not support.
